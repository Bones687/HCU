  ...
  <div id="features-wrapper">
    <section id="features" class="container">
      ...
      <div class="row">
        ...
        <!-- Feature -->
          <section>
            <a href="#" class="image featured"><?php echo img("resource/images/landscape/01.jpg"); ?></a>
            <header>
        ...
        <!-- Feature -->
          <section>
            <a href="#" class="image featured"><?php echo img("resource/images/landscape/02.jpg"); ?></a>
            <header>
        ...
        <!-- Feature -->
        <section>
          <a href="#" class="image featured"><?php echo img("resource/images/landscape/03.jpg"); ?></a>
          <header>
