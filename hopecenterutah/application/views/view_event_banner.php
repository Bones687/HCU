...
<!-- Caption Style -->
    <style> 
        ...
        .bricon
        {
            background: url(resource/images/browser-icons.png);
        }
    </style>
    ...
    <script type="text/javascript" src="../resource/js/jssor.js"></script>
    <script type="text/javascript" src="../resource/js/jssor.slider.js"></script>
    <script>
    ...
    <div id="slider1_container" style="position: relative; width: 600px;
        height: 300px; right: -35%; overflow: hidden;">
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(resource/images/loading.gif) no-repeat center center;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px;
            overflow: hidden;">
            <div>
                <a u=image href="http://google.com"><?php echo img("resource/images/landscape/01.jpg"); ?></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                Event 1
                </div>
                <div style="position:absolute; left:20px; bottom: 30px; color: white; background-color: blue; width: 80px; height:30px; "><a href="#">RSVP</a></div>
            </div>
            <div>
                <a u=image href="#"><?php echo img("resource/images/landscape/02.jpg"); ?></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                Event 2
                </div>
            </div>
            <div>
                <a u=image href="#"><?php echo img("resource/images/landscape/03.jpg"); ?></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                Event 3
                </div>
            </div>
            <div>
                <a u=image href="#"><?php echo img("resource/images/landscape/04.jpg"); ?></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                Event 4
                </div>
            </div>
        ...
        <style>
            ...
            */
            .jssora05l, .jssora05r, .jssora05ldn, .jssora05rdn
            {
            	...
            	cursor: pointer;
            	display: block;
                background: url(resource/images/a17.png) no-repeat;
                overflow:hidden;
                z-index: 100;
            }
